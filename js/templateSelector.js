...
var TemplateSelector = Class.create( {
    ...
    initialize: function(isStartupTemplateSelector) {
        ...
        this.dialog = new PhenoTips.widgets.ModalPopup(this.mainDiv, {close: {method : this.hide.bind(this), keys : closeShortcut}}, {extraClassName: "pedigree-template-chooser", title: "请选择一个模板", displayCloseButton: !isStartupTemplateSelector, verticalPosition: "top"});
