...
var Workspace = Class.create({
        ...
        if (editor.isUnsupportedBrowser()) {
            submenus = [{
                ...
                items: [
                    ...
                    { key : 'reload',    label : '刷新', icon : 'refresh'}
                ]
            }];
        } else {
            submenus = [{
                ...
                items: [
                    ...
                    { key : 'redo',   label : '恢复', icon : 'repeat'},
                    { key : 'layout', label : '排版', icon : 'sitemap'},
                    { key : 'number', label : '标号', icon : 'sort-numeric-asc'}
                ]
              }, {
                name : 'reset',
                items: [
                    { key : 'clear',  label : '全部清除', icon : 'times-circle'},
                    { key : 'reload',    label : '刷新', icon : 'refresh'}
                ]
              }, {
                name : 'output',
    ...
    generateViewControls : function() {
        ...
        ['up', 'right', 'down', 'left', 'home'].each(function (direction) {
            ...
            _this.__pan[direction] = new Element('span', {'class' : 'view-control-pan pan-' + direction + ' fa fa-fw ' + faIconClass, 'title' : ["向上移动", "向右移动", "向下移动", "向左移动", "重置"][['up', 'right', 'down', 'left', 'home'].indexOf(direction)]});
        ...
        this.__zoom.handle = new Element('div', {'class' : 'zoom-handle', title : '缩放'});
