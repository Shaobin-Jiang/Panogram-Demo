...
var OkCancelDialogue = Class.create( {
    ...
    initialize: function() {        
        ...
        buttons.insert(new Element('input', {type: 'button', name : 'ok',     'value': '是', 'class' : 'button width80px', 'id': 'OK_button'}).wrap('span', {'class' : 'buttonwrapper'}));
        buttons.insert(new Element('input', {type: 'button', name : 'cancel', 'value': '否', 'class' : 'button secondary width80px'}).wrap('span', {'class' : 'buttonwrapper'}));
